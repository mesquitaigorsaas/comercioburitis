...
const PLANOS: Record<string, { valor: number; titulo: string }> = {
    trimestral: { valor: 29.7, titulo: "Guia Comercial Buritis — Plano Trimestral (3 meses)" },
    semestral: { valor: 53.46, titulo: "Guia Comercial Buritis — Plano Semestral (6 meses)" },
    anual: { valor: 100.98, titulo: "Guia Comercial Buritis — Plano Anual (12 meses)" }
};
const DESTAQUE = { valor: 120, titulo: "Guia Comercial Buritis — Destaque por 15 dias" };
...
Deno.serve(async (req) => {
    ...
    try {
        ...
        const preferencia = {
            ...
            statement_descriptor: "GUIA BURITIS"
        };
